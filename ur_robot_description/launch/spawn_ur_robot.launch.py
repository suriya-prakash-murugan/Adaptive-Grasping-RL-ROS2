...
def launch_setup(context, *args, **kwargs):
    ...
    world = PathJoinSubstitution(
        [FindPackageShare("ur_robot_description"), "worlds", "cluttered_world.world"]
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [
                    FindPackageShare("ur_robot_description"),
                    "config",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="ur_robot_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="ur_camera.urdf.xacro",
